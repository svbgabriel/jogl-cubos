...
public class CuboMouse extends GLCanvas implements GLEventListener, KeyListener, MouseListener {
	...
	public void mouseClicked(MouseEvent e) {
		...
		if (botao == MouseEvent.BUTTON1) {
			...
			tx = ((2 * xMax * mouseX) / larguraFrame) - xMax;
			ty = (((2 * yMax) * (mouseY - alturaFrame)) / -alturaFrame) - yMax;
